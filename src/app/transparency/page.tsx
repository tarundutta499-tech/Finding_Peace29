          ...
          <div className="bg-card border border-border shadow-xl rounded-3xl overflow-hidden">
            ...
            <div className="bg-muted/50 p-6 text-center border-t border-border">
              <p className="text-sm text-muted-foreground">
                For 80G tax exemption receipts, please email your PAN and transaction details to <span className="font-bold text-foreground">connect@findingpeace29.com</span>.
              </p>
            </div>
          </div>
        </div>
