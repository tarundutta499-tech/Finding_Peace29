                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="mt-1 space-y-1">
                        <p className="text-muted-foreground">General & Donations: <a href="mailto:connect@findingpeace29.com" className="hover:text-foreground transition-colors">connect@findingpeace29.com</a></p>
                      </div>
                    </div>
                  </div>
                </div>
